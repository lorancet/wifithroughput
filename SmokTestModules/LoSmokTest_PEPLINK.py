...
def Wan_set(wan):
        ...
        for i in range(wan):
                ...
                Bvisit ('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=wanlink&wanlink='+str(link)) 
                Bcheck('Enable')
        ...
        if wan == 1:
                ...
                Bvisit ('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=wanlink&wanlink=2') 
                Bncheck('Enable')
                time.sleep(5)
                SBclickT('Save')
...
def NAT_Mapping(): #632
        ...
        # Set NAT Mapping
        time.sleep(2)
        Bvisit ('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=natmap')
        time.sleep(2)
        Bclick('.add_action')
        time.sleep(2)
        Bfill('#host', '192.168.1.9')
        time.sleep(2)
...
def Inboun_access_310_632(DL1):
        time.sleep(2)
        Bvisit('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=inboundservers')
        time.sleep(2)
        Bclick('.add_action')
        time.sleep(2)
...
def Inboun_access_20(DL1):
        ...
        time.sleep(2)
        Bclick('#mainContent > article > table > tfoot > tr > td > button')
        time.sleep(2)
        Bfill('#ui-id-1 > table > tr:nth-child(3) > td:nth-child(2) > input','HTTP')
        time.sleep(2)
        Bclick('#ui-id-1 > table > tr.tablecontent2.protocol_tr > td:nth-child(2) > select.protocol_selector_action > optgroup:nth-child(2) > option:nth-child(1)')
        time.sleep(2)
        Bcheck('#inbound_conn_1_hasSelect')
        time.sleep(2)
        Bclick('#ui-id-1 > table > tr:nth-child(6) > td.tablecontent2 > table > tbody > tbody > tr:nth-child(1) > td:nth-child(2) > div.connlist_table_box > label:nth-child(1) > input[type="checkbox"]')
        time.sleep(2)
        Bclick('#ui-id-1 > table > tr:nth-child(6) > td.tablecontent2 > table > tbody > tbody > tr:nth-child(1) > td:nth-child(2) > div.connlist_table_box > label:nth-child(2) > input[type="checkbox"]')
        time.sleep(2)
        ...
        Bclick('#mainContent > article > table > tfoot > tr > td > button')
        time.sleep(2)
        Bfill('#ui-id-1 > table > tr:nth-child(3) > td:nth-child(2) > input','SSH')
        time.sleep(2)
        Bclick('#ui-id-1 > table > tr.tablecontent2.protocol_tr > td:nth-child(2) > select.protocol_selector_action > optgroup:nth-child(2) > option:nth-child(7)')
        time.sleep(2)
        Bcheck('#inbound_conn_1_hasSelect')
        ...
        Bclick('#mainContent > article > table > tfoot > tr > td > button')
        time.sleep(2)
        Bfill('#ui-id-1 > table > tr:nth-child(3) > td:nth-child(2) > input','FTP')
        time.sleep(2)
        Bclick('#ui-id-1 > table > tr.tablecontent2.protocol_tr > td:nth-child(2) > select.protocol_selector_action > optgroup:nth-child(4) > option:nth-child(5)')
        time.sleep(2)
        Bcheck('#inbound_conn_1_hasSelect')
        ...
        Bclick('#mainContent > article > table > tfoot > tr > td > button')
        time.sleep(2)
        Bfill('#ui-id-1 > table > tr:nth-child(3) > td:nth-child(2) > input','POP3')
        time.sleep(2)
        Bclick('#ui-id-1 > table > tr.tablecontent2.protocol_tr > td:nth-child(2) > select.protocol_selector_action > optgroup:nth-child(2) > option:nth-child(4)')
        time.sleep(2)
        Bcheck('#inbound_conn_1_hasSelect')
        ...
        Bclick('#mainContent > article > table > tfoot > tr > td > button')
        time.sleep(2)
        Bfill('#ui-id-1 > table > tr:nth-child(3) > td:nth-child(2) > input','SMTP')
        time.sleep(2)
        Bclick('#ui-id-1 > table > tr.tablecontent2.protocol_tr > td:nth-child(2) > select.protocol_selector_action > optgroup:nth-child(2) > option:nth-child(6)')
        time.sleep(2)
        Bcheck('#inbound_conn_1_hasSelect')
        ...
        Bclick('#mainContent > article > table > tfoot > tr > td > button')
        time.sleep(2)
        Bfill('#ui-id-1 > table > tr:nth-child(3) > td:nth-child(2) > input','ICMP')
        time.sleep(2)
        Bclick('#ui-id-1 > table > tr.tablecontent2.protocol_tr > td:nth-child(2) > select.protocol_action > option:nth-child(3)')
        time.sleep(2)
        Bfill('#ui-id-1 > table > tr.tablecontent2.protocol_tr > td:nth-child(2) > span.icmp_type_panel > input[type="text"]','0')
        time.sleep(2)
        Bcheck('#inbound_conn_1_hasSelect')
        time.sleep(2)
        Bclick('#ui-id-1 > table > tr:nth-child(6) > td.tablecontent2 > table > tbody > tbody > tr:nth-child(1) > td:nth-child(2) > div.connlist_table_box > label:nth-child(1) > input[type="checkbox"]')
        ...
        Bclick('#mainContent > article > table > tfoot > tr > td > button')
        time.sleep(2)
        Bfill('#ui-id-1 > table > tr:nth-child(3) > td:nth-child(2) > input','UDP')
        time.sleep(2)
        Bclick('#ui-id-1 > table > tr.tablecontent2.protocol_tr > td:nth-child(2) > select.protocol_action > option:nth-child(2)')
        time.sleep(2)
        Bclick('#ui-id-1 > table > tr:nth-child(5) > td:nth-child(2) > div > select > option:nth-child(1)')
...
def Enable_CLI():
        ...
        time.sleep(2)        
        Bvisit ('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=utadmin')
        time.sleep(2)
...
def DNS_Server():
        ...
        # Set DNS Server
        time.sleep(2)
        Bvisit ('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=edns')
        time.sleep(2)
...
def SetOutboundPolicy1222():
        ...
        time.sleep(2)
        Bvisit ('192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=outboundpolicy')
        time.sleep(2)
        Bclick('.add_action')
        time.sleep(2)
...
def QosSet():
        ...
        print 'QosSet'
        time.sleep(2)
        Bvisit('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=eqosgroup')
        time.sleep(2)
        SBclickT('Add')
        time.sleep(2)
        Bfill('#user_group_panel > form > table > tbody > tr.tablecontent2.ip_row > td:nth-child(2) > input','192.168.1.9')
        time.sleep(2)
...
def SMNP_Set():
        ...
        time.sleep(2)
        Bvisit('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=utsnmp')
        time.sleep(2)
        BcheckT('SNMPv1')
        BcheckT('SNMPv2c')
        BcheckT('SNMPv3')
        ...
        time.sleep(2)
        BfillT('SNMP Trap Server','192.168.1.9')
        time.sleep(3)
        ...
        time.sleep(2)
        BfillT('Allowed Network','192.168.1.0')
        time.sleep(2)
        SBclickT ('Save')
        time.sleep(3)
        ...
        Bclick('#allContent > div:nth-child(11) > form > table > tbody > tr:nth-child(2) > td:nth-child(2) > select > option:nth-child(2)')
        time.sleep(2)
        ...
        Bclick('#allContent > div:nth-child(11) > form > table > tbody > tr:nth-child(2) > td:nth-child(2) > select > option:nth-child(3)')
        time.sleep(2)
        Bfill('input.auth_fields','peplink5978')
        time.sleep(2)
        SBclickT ('Save')
...
def SF_toLoFH1():
        ...
        time.sleep(2)
        Bvisit('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=advmvpn')
        time.sleep(2)
...
def PepAnalysis():
        ...
        time.sleep(2)    
        Bvisit('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=pepvpnstatus')
        time.sleep(2)
...
def UIRestD():
        ...
        Bvisit ('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=utconfig')
        time.sleep(2)
...
def EnableRA():
        ...
        Bvisit ('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=utsysinfo')
        Bsleep(2)        
        BclickT("Turn On")
        Bsleep(2)        
