...
PogoUpdate1('B710_Smoke_Test_Balance.py','/QaPythonTemp/QaAutoRunTest/U64_Smoke_Test/','')

UpdateSfolder = 'QaPythonTemp/QaAutoRunTest/U64_Smoke_Test/ConfigFile'
UpdateDfolder = 'ConfigFile'
...
class SmokeTest (unittest.TestCase):
    ...
    def test_case043(self):
        ...
        try:
            ...
            UIsLogin(pepurl)
            Wan_set(1) 
            Inboun_access_310_632('192.168.1.9')
            time.sleep(10)
            UIsApply(pepurl)
            time.sleep(AppWait)
