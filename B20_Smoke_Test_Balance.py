...
from ConfigFile.T05.config import *
...
PogoUpdate1('B20_Smoke_Test_Balance.py','/QaPythonTemp/QaAutoRunTest/U64_Smoke_Test/','')

UpdateSfolder = 'QaPythonTemp/QaAutoRunTest/U64_Smoke_Test/ConfigFile/T05'
UpdateDfolder = 'ConfigFile/T05'
