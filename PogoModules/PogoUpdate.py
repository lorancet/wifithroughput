# coding=UTF-8
PogoUpdateVer = '2019/2/21 v1.0.15'
    ...
    if ftp != 0:         
        ...
        for item in ftp.walk(UpdateSfolder):
            ...
            for subdir in item[1]:
                ...
                try:
                    if os.makedirs(UpdateDfolder + '/' + subdir):
                         print("Creating dir " + UpdateDfolder + '/' + subdir)                 
                except Exception,e :
                    print("Exist dir "  + UpdateDfolder + '/' + subdir)                  
                    
            for file in item[2]:                
                if ftp.download_if_newer(ftp.path.join(item[0],file), UpdateDfolder +  subdd + '/'+ file):
                    UpdateCount += 1
