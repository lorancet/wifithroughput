...
PogoUpdate1('MOTG_Smoke_Test_Balance.py','/QaPythonTemp/QaAutoRunTest/U64_Smoke_Test/','')
...
def Config_File_Upload(FileName):
    ...
    FilePath = '/home/peplink/QA/QaPythonTemp/QaAutoRunTest/U64_Smoke_Test/ConfigFile/'
...
class SmokeTest (unittest.TestCase):
    ...
    def test_case001(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case001.conf')
            ...
            if result[0] == 'Connected':
                ...
                print ("PASS")
                Bquit()
                Config_File_Upload('MOTG_720_FactoryReset.conf')
    ...
    def test_case002(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case002.conf')
    ...
    def test_case003(self):
        ...
        a = 0
        try:
            Config_File_Upload('MOTG_720_test_case003.conf')
    ...
    def test_case004(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case004.conf')
    ...
    def test_case005(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case005.conf')
    ...
    def test_case006(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case006.conf')
    ...
    def test_case007(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case007.conf')
    ...
    def test_case008(self):
        ...
        try:
            ...
            os.system('nmcli device connect ens18') 
            time.sleep(2)
            Config_File_Upload('MOTG_720_test_case008.conf')
    ...
    def test_case010(self):
        ...
        try:
            ...
            os.system('nmcli device connect ens18') 
            time.sleep(2)
            Config_File_Upload('MOTG_720_test_case010.conf')
    ...
    def test_case011(self):
        ...
        try:
            ...
            BclickT("Details")
            Bsleep(5)
            Bclick('#ui-id-7 > form:nth-child(2) > table:nth-child(7) > tbody:nth-child(15) > tr > td:nth-child(2) > div > label:nth-child(1) > input[type="radio"]')
            Bsleep(5)
    ...
    def test_case013(self):
        ...
        a = 0
        try:
            Config_File_Upload('MOTG_720_test_case013.conf')
            time.sleep(AppWait)
            ...
            if "Connection Status              : Connected" in result[4]:
                a += 1
                
            if "Connection Status              : Scanning..." in result[5]:
                a += 1
    ...
    def test_case014(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case014.conf')
            ...
            print Total_Sessions1[-1]
            print Total_Sessions2[-1]
    ...
    def test_case015(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case015.conf')
    ...
    def test_case016(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case016.conf')
    ...
    def test_case017(self):
        ...
        a = 0
        try:
            Config_File_Upload('MOTG_720_test_case017.conf')
    ...
    def test_case018(self):
        ...
        a = 0        
        try:
            Config_File_Upload('MOTG_720_test_case018.conf')
    ...
    def test_case019(self):
        ...
        a = 0
        try:
            Config_File_Upload('MOTG_720_test_case019.conf')
    ...
    def test_case020(self):
        ...
        try:
            ...
            time.sleep(2)
            BfillT('DHCP Reservation', '192.168.50.200','3','0','1')
            time.sleep(2)
            BclickT('Save')
            UIsApply(pepurl)
            Bquit()
    ...
    def test_case022(self):
        ...
        try:
            ...
            BfillT('DHCP Reservation',PC_MAC,'2','0','1')        
            time.sleep(2)
            BfillT('DHCP Reservation', '192.168.50.'+str(b),'3','0','1')
            time.sleep(2)
            BclickT('Save')
            time.sleep(2)
            UIsApply(pepurl)
    ...
    def test_case029(self):
        ...
        try:
            ...
            MOTG_Wan_set()
            time.sleep(2)
            Bvisit ('http://192.168.50.1/cgi-bin/MANGA/index.cgi?mode=config&option=admin')
            time.sleep(2)
    ...
    def test_case030(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case030.conf')
            time.sleep(AppWait)
    ...
    def test_case031(self):
        ...
        "Case_1108 DDNS Support changeip.com"
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case031.conf')
            time.sleep(AppWait)
            ...
            time.sleep(2)
            ssh.connect('10.88.80.11' , port=22 ,username='peplink' , password='peplink')
            stdin, stdout, stderr = ssh.exec_command('nslookup -type=a pepttc.dynamic-dns.net 8.8.8.8 |grep Address')
            time.sleep(2)
            p=1
            for std in stdout.readlines():
                if ('Address' in std) and (p==2):
    ...
    def test_case032(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case032.conf')
            time.sleep(AppWait)
    ...
    def test_case033(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case033.conf')
            time.sleep(AppWait)
    ...
    def test_case034(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case034.conf')
            time.sleep(AppWait)
            ...
            UIsLogin(pepurl)
            time.sleep(5)
            Bvisit('http://192.168.50.1/cgi-bin/MANGA/index.cgi?mode=config&option=wanlink&wanlink=5')
            time.sleep(2)
            Bncheck('#enable_display > td:nth-child(2) > input[type="checkbox"]')
            #BclickT('Disconnect')
            time.sleep(6)
            BclickT('Save')
            time.sleep(2)
            ...
            Bvisit('http://192.168.50.1/cgi-bin/MANGA/index.cgi?mode=config&option=wanlink&wanlink=5')
            time.sleep(2)
            Bcheck('#enable_display > td:nth-child(2) > input[type="checkbox"]')
            time.sleep(6)
            BclickT('Save')
            time.sleep(2)
            UIsApply(pepurl)
    ...
    def test_case035(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case035.conf')
            time.sleep(AppWait)
    ...
    def test_case036(self):
        ...
        try:
            Config_File_Upload('MOTG_720_test_case036.conf')
            time.sleep(AppWait)
    ...
    def test_case037(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case037.conf')
            time.sleep(AppWait)
    ...
    def test_case038(self):
        ...
        try:
            Config_File_Upload('MOTG_720_test_case038.conf')
            time.sleep(AppWait)
    ...
    def test_case039(self):
        ...
        try:
            Config_File_Upload('MOTG_720_test_case039.conf')
            time.sleep(AppWait)
    ...
    def test_case040(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case040.conf')
            time.sleep(AppWait)
    ...
    def test_case041(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case041.conf')
            time.sleep(AppWait)
    ...
    def test_case042(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case042.conf')
            time.sleep(AppWait)
    ...
    def test_case043(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case043.conf')
            time.sleep(AppWait)
    ...
    def test_case044(self):
        ...
        try:
            ...
            Config_File_Upload('MOTG_720_test_case044.conf')
            time.sleep(AppWait)
    ...
    def test_case045(self):
        ...
        try:
            Config_File_Upload('MOTG_720_test_case045.conf')
            time.sleep(AppWait)
            ssh.connect('10.88.81.254' , username="peplink" , password="peplink")
            time.sleep(2)
            ssh.exec_command('echo peplink | sudo -S tc qdisc add dev ens20 root netem delay 200ms 190ms loss 0.3')
            time.sleep(10)
            ...
            ssh.connect('10.88.81.254' , username="peplink" , password="peplink")
            time.sleep(2)
            ssh.exec_command('echo peplink | sudo -S tc qdisc del dev ens20 root netem delay 200ms 190ms loss 0.3')
            time.sleep(2)
    ...
    def test_case063(self):
        ...
        try:
            ...
            time.sleep(10)
            # IPSec 設定    
            Bvisit ('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=ipsec')
            time.sleep(2)
            Bclick ('.ipsec_add_button')
            time.sleep(2)
            Bfill ('name','toFusionHubIPSec') 
            time.sleep(2)
            Bcheck('ipsec_enable')
            time.sleep(2)
            Bfill ('ipsec_remote_gateway', '10.88.80.3') 
            time.sleep(2)
            Bfill ('_ip', '192.168.3.0')
            time.sleep(2)
            Bcheck('#ipsec_dialog > form > table:nth-child(6) > tbody:nth-child(1) > tr:nth-child(8) > td:nth-child(2) > label:nth-child(2) > input')
            time.sleep(2)
            Bfill('#ipsec_dialog > form > table:nth-child(6) > tbody:nth-child(1) > tr.tablecontent2.x509_display > td:nth-child(2) > textarea', X509_Certificate)
            time.sleep(2)
    ...
    def test_case084(self):
        ...
        try:
            a = 'RAHost:192.168.1.1RAPort:2222~#iptables-tmangle-nvLIDS_ICMPChainIDS_ICMP(1references)pktsbytestargetprotoptinoutsourcedestination~#'
            driver = Bopen()
            time.sleep(2)
            UIsLogin(pepurl)
            time.sleep(2)
    ...
    def test_case086(self):
        ...
        try:
            ...
            time.sleep(2)
            Bcheck('#ftp_display > label > input')
            time.sleep(2)
            Bfill('#ftp_custom_display > input:nth-child(1)','2121')
            time.sleep(2)
            BclickT('Save')
            time.sleep(10)
            UIsApply(pepurl)
    ...
    def test_case090(self):
        ...
        try:
            ...
            time.sleep(2)
            Bfill('#webproxy_forwarding_panel > div > table:nth-child(2) > tbody.row_panel > tr:nth-child(1) > td:nth-child(3) > input:nth-child(2)','8080')
            time.sleep(2)
            BclickT('Save')
            time.sleep(10)
            UIsApply(pepurl)
    ...
    def test_case202(self):
        ...
        try:
            ...
            MOTG_Wan_set() 
            InboundAccessLoadWeight()
            Bvisit('http://192.168.1.1/cgi-bin/MANGA/index.cgi?mode=config&option=inbounddistribution')
            time.sleep(2)
            Bclick('#mainContent > article > table > tbody > tr > td.tabletitle2.name > a')
            time.sleep(2)
            Bdrop_offset('#ui-id-1 > table > tr.multiple_server_panel > td.tablecontent2 > table > tbody > tr.tablecontent2.server_1 > td > div > div > span',-60,0)
            time.sleep(2)
            Bdrop_offset('#ui-id-1 > table > tr.multiple_server_panel > td.tablecontent2 > table > tbody > tr.tablecontent2.server_2 > td > div > div > span',-100,0)            
            BclickT ('Save')
            time.sleep(10)
            UIsApply(pepurl)
            time.sleep(AppWait)
...
if __name__ == '__main__':
    ...
    IpAdd = '192.168.50.1'
    #以上是給 Pepwave 產品的改 LAN 網段 至 192.168.1.1
